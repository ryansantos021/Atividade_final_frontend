function calcularIMC() {
    ...
    if (altura > 0 && peso > 0) {
        ...
        resultado.style.color = mensagem === 'Peso adequado' ? 'blue' : mensagem === 'Obeso' ? 'blue' : 'blue';
		
		// Após o cálculo do IMC, mostramos o banner após 3 segundos
        setTimeout(function() {
